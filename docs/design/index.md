...
| [`p0-contract-decision-proposal.md`](p0-contract-decision-proposal.md) | 구현 전 계약의 구체 권장안, API·DB·AI·route 기준선과 제품 소유자 승인 항목을 제안한다.                                             |
...
- P0 계약 결정 제안서는 설계의 미결 항목을 구현 가능한 권장 계약과 제품 소유자 질문으로 변환하되 승인 전 확정 계약으로 취급하지 않는다.
