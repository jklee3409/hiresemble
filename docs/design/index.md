...
- GitHub·Career Artifact 설계는 Gate 0–4 `DONE`과 V29 GitHub App private source, V30 terminal account purge를 11개 WorkflowType에 연결한다. Gate 5는 `IMPLEMENTED_NOT_VERIFIED`, 실제 외부 UAT는 `USER_MANUAL_UI_VALIDATION_PENDING`이며 OpenAPI는 private 활성 97/128·private 비활성 90/121·Career Artifact 비활성 81/110이다.
