...
- GitHub·Career Artifact 설계는 Gate 0~1에서 V26 기준선을 보호하고 V27/9개 WorkflowType/79 paths·107 operations의 GitHub Backend를 연결한다. Gate 2~4 Frontend·Career Artifact 계약은 `PLANNED`다.
