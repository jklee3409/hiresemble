...
각 phase 시작 시 latest migration과 implemented OpenAPI baseline을 다시 확인한다. 공고 자동 분석 후속 의도 V16까지 구현됐으며 미래 V17~V20과 API·route는 실제 merge 전까지 tentative/`PLANNED`로 유지한다.
