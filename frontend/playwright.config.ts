...
const frontendBaseUrl =
  process.env.P8_FRONTEND_BASE_URL ??
...
const skipWebServer =
  process.env.P8_SKIP_WEB_SERVER === 'true' ||
...
export default defineConfig({
  ...
  use: {
    ...
    trace:
      process.env.P8_E2E_ENABLED === 'true' || process.env.P7_E2E_ENABLED === 'true'
        ? 'retain-on-failure'
        : 'on-first-retry',
  },
  projects: [
