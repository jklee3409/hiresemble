...
| [`e2e/`](e2e/)                                 | Playwright UI shell·Agent Run fixture와 실제 profile·Document·Job E2E |
...
- `src/styles`와 `src/shared/ui`가 제품 design token, 공통 form/action/status/state pattern을 제공한다.
- `src/layouts`, `src/features`, `src/pages`는 responsive 인증·보호 shell, profile, Agent Run·Progress Drawer, Document 검토와 Job 수명주기 흐름을 제공한다.
