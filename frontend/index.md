...
| [`e2e/`](e2e/)                                 | Playwright profile·Agent Run fixture와 실제 Document·Job E2E |
...
- `src/layouts`, `src/features`, `src/pages`는 인증 shell, profile, Agent Run·Progress Drawer, Document 검토와 Job 수명주기 흐름을 제공한다.
...
- Dashboard 집계, AI 설정과 P6 이후 route는 아직 구현되지 않았으므로 shell이나 placeholder를 제품 기능 완료로 기록하지 않는다.
