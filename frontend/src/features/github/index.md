...
공개/GitHub App private source와 connection의 owner-scoped query key, 등록·저장소 선택·새로고침·삭제 mutation,
idempotency identity, callback URL 정리와 화면 표시 규칙을 관리한다. Agent Run stream은 공용
