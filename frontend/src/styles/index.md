...
- `main.css`는 Tailwind utility 생성과 함께 `#3157ff` Hiresemble Blue scale, neutral canvas·surface·ink·muted·border, semantic color, 제한된 radius·shadow, 80rem content width·15rem app sidebar와 typography token을 선언한다.
