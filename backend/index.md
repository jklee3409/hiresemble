...
- [`src/main/resources/`](src/main/resources/)는 Spring 설정과 V1~V30 Flyway migration을 소유한다. V29는 GitHub App/private repository·revocation, V30은 FK 없는 terminal account deletion task를 추가한다.
