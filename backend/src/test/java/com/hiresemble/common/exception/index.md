...
P1 ErrorCode 집합의 고유성과 HTTP 오류 status 성질을 검증한다.

## 주요 파일 및 하위 디렉터리

- [`ErrorCodeTest.java`](ErrorCodeTest.java): code 고유성·message·4xx/5xx assertion
- [`progress.md`](progress.md): 이 영역의 구현·검증 이력

## 구성 요소 역할

- ErrorCode 추가 시 중복·성공 status 혼입을 빠르게 탐지한다.
...
- 미래 전체 code 목록을 test 때문에 선행 생성하지 않는다.
