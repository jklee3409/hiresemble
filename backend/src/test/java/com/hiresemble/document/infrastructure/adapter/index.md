# Document 테스트 Adapter package 안내

## 디렉터리 목적

`com.hiresemble.document.infrastructure.adapter` package는 Document parser 외부 경계의 회귀·계약 테스트를 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentParserTest.java](DocumentParserTest.java) | Adapter 책임 구현 |
| [progress.md](progress.md) | 이 package의 이동·검증 이력 |

## 구성 요소 역할

- PDF·DOCX·TXT parser와 방어 경계를 검증한다.
