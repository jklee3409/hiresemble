...
- `DocumentTextPipelineTest`: Unicode count, PII masking, deterministic chunk
- `ObjectDeletionOutboxIntegrationTest`: claim·lease·retry·DEAD·alert
- [`progress.md`](progress.md): application 테스트 이력
