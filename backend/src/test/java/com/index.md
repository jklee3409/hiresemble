# 백엔드 테스트 com namespace 안내

## 디렉터리 목적

Hiresemble JUnit package의 중간 Java namespace를 관리한다.

## 주요 파일 및 하위 디렉터리

- [`hiresemble/`](hiresemble/index.md): 프로젝트 소유 테스트 package
- [`progress.md`](progress.md): 이 영역의 구현·검증 이력

## 구성 요소 역할

- 외부 package와 프로젝트 test code의 경계를 명확히 한다.

## 다른 디렉터리와의 의존 관계

- 상위 [`java/`](../index.md)의 책임 경계 안에서 동작한다.
- 공개 HTTP·화면 계약은 [`docs/spec/api.md`](../../../../../docs/spec/api.md)와 [`docs/spec/page.md`](../../../../../docs/spec/page.md)를 따른다.

## 변경 시 주의사항

- 중간 namespace에 기능 test를 직접 두지 않는다.
