...
| 경로                                             | 역할                                                              |
| ------------------------------------------------ | ----------------------------------------------------------------- |
| [`application.yml`](application.yml)             | datasource, Session·AI·Document·Job·Cover Letter와 OpenAPI 설정 |
...
- `application.yml`은 선택적 `.env`를 읽고 Session·Cookie, versioned HMAC, bounded Agent worker, Document·Job·Cover Letter workflow cost override를 정의한다.
