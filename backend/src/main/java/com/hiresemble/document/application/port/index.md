# Document Port package 안내

## 디렉터리 목적

com.hiresemble.document.application.port package는 application과 외부 구현 사이의 명시적 경계를 정의한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentWorkflowCommandPort.java](DocumentWorkflowCommandPort.java) | Port 책임 구현 |
