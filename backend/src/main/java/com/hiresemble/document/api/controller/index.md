# Document Controller package 안내

## 디렉터리 목적

com.hiresemble.document.api.controller package는 인증 context와 HTTP 입력·출력을 application use case에 연결한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentController.java](DocumentController.java) | Controller 책임 구현 |
