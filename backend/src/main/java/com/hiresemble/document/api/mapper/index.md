# Document Mapper package 안내

## 디렉터리 목적

com.hiresemble.document.api.mapper package는 application 결과와 외부 전송 DTO 사이의 변환을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentApiMapper.java](DocumentApiMapper.java) | Mapper 책임 구현 |
