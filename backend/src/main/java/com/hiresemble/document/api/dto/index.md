# Document DTO package 안내

## 디렉터리 목적

com.hiresemble.document.api.dto package는 외부 request·response와 event의 타입 안전한 전송 계약을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentDtos.java](DocumentDtos.java) | DTO 책임 구현 |
| [DocumentRequests.java](DocumentRequests.java) | DTO 책임 구현 |
