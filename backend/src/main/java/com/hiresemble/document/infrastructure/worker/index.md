# Document Worker package 안내

## 디렉터리 목적

com.hiresemble.document.infrastructure.worker package는 DB 상태를 기준으로 비동기 작업과 복구 실행을 조정한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [ObjectDeletionOutboxService.java](ObjectDeletionOutboxService.java) | Worker 책임 구현 |
