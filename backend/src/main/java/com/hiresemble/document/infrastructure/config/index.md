# Document Configuration package 안내

## 디렉터리 목적

com.hiresemble.document.infrastructure.config package는 해당 계층의 Spring 실행 설정과 typed configuration을 소유한다.
...
| [DocumentParserProperties.java](DocumentParserProperties.java) | Configuration 책임 구현 |
| [ObjectDeletionOutboxProperties.java](ObjectDeletionOutboxProperties.java) | Configuration 책임 구현 |
| [ObjectStorageProperties.java](ObjectStorageProperties.java) | Configuration 책임 구현 |
