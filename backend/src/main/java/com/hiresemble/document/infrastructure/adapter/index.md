# Document Adapter package 안내

## 디렉터리 목적

com.hiresemble.document.infrastructure.adapter package는 Object Storage·parser 같은 외부 경계 구현을 소유한다.
...
- Object Storage·parser 같은 외부 경계 구현을 소유한다.
