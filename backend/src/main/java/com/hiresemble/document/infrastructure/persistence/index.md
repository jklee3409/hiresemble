# Document Persistence package 안내

## 디렉터리 목적

com.hiresemble.document.infrastructure.persistence package는 JDBC/JPA 기반 저장·조회 구현과 mapping을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [DocumentStore.java](DocumentStore.java) | Persistence 책임 구현 |
| [ObjectDeletionOutboxStore.java](ObjectDeletionOutboxStore.java) | Persistence 책임 구현 |
