...
com.hiresemble.agentrun.domain.model package는 해당 계층에서 사용하는 상태·값·결과 모델을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [AgentRun.java](AgentRun.java) | Model 책임 구현 |
| [AgentRunStatus.java](AgentRunStatus.java) | Model 책임 구현 |
| [AgentStep.java](AgentStep.java) | Model 책임 구현 |
| [AgentStepStatus.java](AgentStepStatus.java) | Model 책임 구현 |
| [AiQualityMode.java](AiQualityMode.java) | Model 책임 구현 |
| [ModelTier.java](ModelTier.java) | Model 책임 구현 |
| [PartialResult.java](PartialResult.java) | Model 책임 구현 |
| [RequiredUserAction.java](RequiredUserAction.java) | Model 책임 구현 |
| [RequiredUserActionType.java](RequiredUserActionType.java) | Model 책임 구현 |
