# Agent Run Mapper package 안내

## 디렉터리 목적

com.hiresemble.agentrun.api.mapper package는 application 결과와 외부 전송 DTO 사이의 변환을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [AgentRunApiMapper.java](AgentRunApiMapper.java) | Mapper 책임 구현 |
| [progress.md](progress.md) | 이 package의 이동·검증 이력 |

## 구성 요소 역할

- application 결과와 외부 전송 DTO 사이의 변환을 소유한다.
