# Agent Run Scheduling package 안내

## 디렉터리 목적

com.hiresemble.agentrun.infrastructure.scheduling package는 주기 reconciliation과 lease 복구 실행을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [ScheduledAgentRunLeaseHeartbeat.java](ScheduledAgentRunLeaseHeartbeat.java) | Scheduling 책임 구현 |
| [progress.md](progress.md) | 이 package의 이동·검증 이력 |

## 구성 요소 역할

- 주기 reconciliation과 lease 복구 실행을 소유한다.
