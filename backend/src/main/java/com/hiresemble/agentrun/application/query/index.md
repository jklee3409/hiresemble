# Agent Run Query package 안내

## 디렉터리 목적

com.hiresemble.agentrun.application.query package는 조회 use case의 입력 값을 정의한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [AgentRunListCriteria.java](AgentRunListCriteria.java) | Query 책임 구현 |
| [AgentRunSort.java](AgentRunSort.java) | Query 책임 구현 |
| [progress.md](progress.md) | 이 package의 이동·검증 이력 |

## 구성 요소 역할

- 조회 use case의 입력 값을 정의한다.
