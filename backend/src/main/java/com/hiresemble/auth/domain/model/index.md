...
com.hiresemble.auth.domain.model package는 해당 계층에서 사용하는 상태·값·결과 모델을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [UserRole.java](UserRole.java) | Model 책임 구현 |
| [UserStatus.java](UserStatus.java) | Model 책임 구현 |
