...
- [`../agentrun/application/`](../agentrun/application/index.md), [`../document/application/`](../document/application/index.md)과 [`../job/application/`](../job/application/index.md)의 port만 소비하며 repository를 직접 참조하지 않는다.
