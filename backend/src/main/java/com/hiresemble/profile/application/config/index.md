# 프로필 Configuration package 안내

## 디렉터리 목적

com.hiresemble.profile.application.config package는 해당 계층의 Spring 실행 설정과 typed configuration을 소유한다.

## 주요 파일 및 하위 디렉터리

| 파일 | 역할 |
| ---- | ---- |
| [ProfileP4PortConfiguration.java](ProfileP4PortConfiguration.java) | Configuration 책임 구현 |
