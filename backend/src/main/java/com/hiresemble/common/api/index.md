...
ControllerAdvice와 Security가 함께 사용하는 공개 오류 DTO·생성 규칙을 소유한다.

## 주요 파일 및 하위 디렉터리

- [ErrorResponseDto.java](ErrorResponseDto.java): 현재 package에 직접 남는 구현
- [ErrorResponseFactory.java](ErrorResponseFactory.java): 현재 package에 직접 남는 구현
- [FieldErrorDto.java](FieldErrorDto.java): 현재 package에 직접 남는 구현
